...
class ServicenowApiWithProxyUserV1
  # ==== Parameters
  ...
  def execute
    ...
    begin
      ...
      # Fetch User by username from SQL DB and get servicenow username/pw
      
      # Try the operation using basic auth. 
      
      # Catch error.

      # If is a PW error, reset the users PW in servicenow using the servicenow system account.
      # Do the call to servicenow
      # Update the Database with the latest pw.
